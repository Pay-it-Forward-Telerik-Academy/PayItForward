                ...
                <div class="row">
                    <div class="col s6 offset-s3">
                        <div class="card-panel z-depth-4">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="CurrentPassword"
                                        ForeColor="Red" ErrorMessage="The current password field is required." ValidationGroup="ChangePassword"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ControlToValidate="NewPassword"
                                        ForeColor="Red" ErrorMessage="The  new password field is required." ValidationGroup="ChangePassword" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
                            ...
                            <div class="center">
                                <asp:Button runat="server" OnClick="ChangePassword_Click" Text="Change Password"  ValidationGroup="ChangePassword" CssClass="waves-effect waves-light btn" />
                            </div>
                        </div>
                    </div>
                </div>
